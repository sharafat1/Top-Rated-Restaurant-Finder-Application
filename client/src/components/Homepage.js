...
export default function Homepage() {
	...
	// if id exists in the params url, it will set select as the id and give it as a prop
	useEffect(() => {
		if (id) {
			setSelected(id);
		}
	...
	// fetch api get suggested cities names
	...
	//if user clicks the city in the drop down, it will add the city id to select and give it as a prop to the restaurants list component
	...
	//rending suggestions dropdown menu
